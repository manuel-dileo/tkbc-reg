...
def to_logfile(c, path):
    outfile = "{}/bitcoinalpha.{}.log".format(path, summary(c).replace("/", "_")) #change here for other datasets
    return outfile
...
def main(argv):
    ...
    path = 'logs/bitcoinalpha'
    path_from_here = 'scripts/logs/bitcoinalpha'
